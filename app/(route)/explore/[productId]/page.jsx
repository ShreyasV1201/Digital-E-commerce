        ...
        <div className="mt-10 px-5 md:px-10 lg:px-20 xl:px-32 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-6 gap-6">
                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <h2 style={{ color: "red" }} className='font-bold text-3xl'>${product?.price}</h2>

                    <p className='text-gray-500 mt-3'>The {product?.category} will send to your registered email id once you purchase this digital content</p>
